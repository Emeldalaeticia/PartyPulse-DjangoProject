...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework.authentication.TokenAuthentication',  # Enable token-based authentication
...
TEMPLATES = [
    {
        ...
        'DIRS': [
             # Add the path to the first templates folder
            os.path.join(BASE_DIR, 'edge', 'templates'),
            # Add the path to the second templates folder
            os.path.join(BASE_DIR, 'templates'),
            # Add the path to the third templates folder
